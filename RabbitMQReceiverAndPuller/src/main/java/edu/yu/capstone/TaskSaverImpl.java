...
//        Connection connection = factory.newConnection();
     ...
     */
    @Override
    public void updateTask(String taskId, EventType eventType, EventName eventName, TaskStatus status, Integer requeueNum) {
        String isDBSetup = System.getenv("IS_DB_SETUP");
        boolean isDBSetupBool = Boolean.parseBoolean(isDBSetup);
        if (!isDBSetupBool) {
            System.out.println("Database is not setup. Defaulting to NoOpTaskSaver.");
        ...
        restTemplate.put(BASE_URL + "/tasks/update/" + taskId, request);
