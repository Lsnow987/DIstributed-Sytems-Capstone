...
public class Task implements TranscodingTask {
     ...
     */
    public Task(int jobId, int taskId, Map<String, String> segmentsToPartition, String bucketPull, String bucketPush, String resolution, String uploadName, TaskStatus status, int requeueNumber) {
        this.jobId = jobId;
        this.taskId = taskId;
